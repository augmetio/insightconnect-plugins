...
class TestClearIpList(TestCase):
    def test_integration_clear_ip_list(self):
        """
        ...
        test_action = ClearIpList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/clear_ip_list.json") as file:
