...
from icon_ip_list_manager.actions.remove_ip_from_list import RemoveIpFromList
import json
import logging


class TestRemoveIpFromList(TestCase):
    def test_integration_remove_ip_from_list(self):
        """
        ...
        test_action = RemoveIpFromList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/remove_ip_from_list.json") as file:
    ...
    def test_remove_ip_from_list(self):
        """
