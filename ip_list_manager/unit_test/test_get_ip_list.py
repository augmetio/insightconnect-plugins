...
from icon_ip_list_manager.actions.get_ip_list import GetIpList
import json
import logging


class TestGetIpList(TestCase):
    def test_integration_get_ip_list(self):
        """
        ...
        test_action = GetIpList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/get_ip_list.json") as file:
        ...
        self.assertTrue("ip_list" in results.keys())
        self.assertTrue(type(results.get("ip_list")) == list)
